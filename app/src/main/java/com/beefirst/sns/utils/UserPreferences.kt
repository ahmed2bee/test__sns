...
import com.beefirst.sns.BaseApplication
...
class UserPreferences {
    ...
    fun getLoggedInUser(): VerificationOTPModel {
        val userData: String = sharePreferences.getString("KEY_USER_DATA", "")!!
        return Gson().fromJson(userData, VerificationOTPModel::class.java)
    }

    fun setLoggedInUser(user: VerificationOTPModel) {
